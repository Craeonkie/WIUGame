...
public class InteractiveHoverButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    private void OnEnable()
    {
        ...
        MenuManager.OnUpdateQuality += UpdateOriginalTextFont;
    }
